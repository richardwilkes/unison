...
var DefaultTableTheme = TableTheme{
	...
	InteriorDividerInk:     PrimaryTheme.Surface.DeriveLightness(-0.05, 0.1),
	...
	IndirectSelectionInk:   PrimaryTheme.Primary.DeriveLightness(-0.1, -0.15),
	OnIndirectSelectionInk: PrimaryTheme.Primary.DeriveLightness(-0.1, -0.15).DeriveOn(),
