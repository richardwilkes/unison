...
func (d *fileDialog) rebuildFileList() {
	...
	if d.fileList.Parent() != nil {
		_, pref, _ := d.fileList.Sizes(geom32.Size{})
		d.fileList.SetFrameRect(geom32.Rect{Size: pref})
