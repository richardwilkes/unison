...
This version of Unison was built using Go 1.21. It has been compiled under many earlier versions of Go in the past, but
only Go 1.21+ will be considered as I make further changes.
