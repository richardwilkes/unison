...
func main() {
	...
	processSourceTemplate(wd, &enumInfo{
		...
		Values: []enumValue{
			...
			{Key: "toggle-button", Comment: "A button that stays in an on or off state"},
			{Key: "disclosure-triangle", Comment: "A control that shows or hides the children of a row"},
			{Key: "check-box", Comment: "A control with an on, off, or mixed state"},
			{Key: "radio-button", Comment: "One choice within a mutually exclusive set"},
			...
			{Key: "text-field", Comment: "A single-line editable text control"},
			{Key: "text-area", Comment: "A multi-line editable text control"},
			{Key: "spin-button", Comment: "An editable numeric control with increment and decrement"},
			{Key: "combo-box", Comment: "An editable text control paired with a list of choices"},
			{Key: "popup-button", Comment: "A button showing the current choice that pops up the list of choices"},
			{Key: "slider", Comment: "A control that picks a value from a range by position"},
			{Key: "progress-bar", Comment: "An indicator of how much of a task has been completed"},
			{Key: "scroll-bar", Comment: "A control that scrolls something else"},
			{Key: "scroll-area", Comment: "A container presenting a scrollable view onto its content"},
			{Key: "separator", Comment: "A divider between elements"},
			{Key: "list", Comment: "A container of selectable items"},
			{Key: "list-item", Comment: "One item within a list"},
			...
			{Key: "column-header", Comment: "The header for one column"},
			{Key: "table-header", Comment: "The container holding a table's column headers"},
			{Key: "tab-list", Comment: "A container of tabs"},
			{Key: "tab", Comment: "One tab within a tab list"},
			{Key: "tab-panel", Comment: "The content shown for the selected tab"},
			{Key: "menu-bar", Comment: "The container holding a window's top-level menus"},
			{Key: "menu", Comment: "A list of menu items"},
			{Key: "menu-item", Comment: "One item within a menu"},
			{Key: "image", Comment: "A graphic whose name describes what it shows"},
			{Key: "color-well", Comment: "A control that shows and edits a color"},
