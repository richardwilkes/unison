...
func DocumentSVG() *SVG {
	if documentSVG == nil {
		var err error
		documentSVG, err = NewSVG(NewSize(384, 512), "M224 136V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.2 0-24-10.8-24-24zm160-14.1v6.1H256V0h6.1c6.4 0 12.5 2.5 17 7l97.9 98c4.5 4.5 7 10.6 7 16.9z")
		jot.FatalIfErr(err)
	}
	return documentSVG
}
...
func WindowMaximizeSVG() *SVG {
	if windowMaximizeSVG == nil {
		var err error
		windowMaximizeSVG, err = NewSVG(NewSize(512, 512), "M464 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48zm-16 160H64v-84c0-6.6 5.4-12 12-12h360c6.6 0 12 5.4 12 12v84z")
		jot.FatalIfErr(err)
	}
