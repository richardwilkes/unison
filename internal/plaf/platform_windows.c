...
static void createKeyTables(void)
{
	...
	_glfw.keyCodes[0x00B] = KEY_0;
	_glfw.keyCodes[0x002] = KEY_1;
	_glfw.keyCodes[0x003] = KEY_2;
	_glfw.keyCodes[0x004] = KEY_3;
	_glfw.keyCodes[0x005] = KEY_4;
	_glfw.keyCodes[0x006] = KEY_5;
	_glfw.keyCodes[0x007] = KEY_6;
	_glfw.keyCodes[0x008] = KEY_7;
	_glfw.keyCodes[0x009] = KEY_8;
	_glfw.keyCodes[0x00A] = KEY_9;
	_glfw.keyCodes[0x01E] = KEY_A;
	_glfw.keyCodes[0x030] = KEY_B;
	_glfw.keyCodes[0x02E] = KEY_C;
	_glfw.keyCodes[0x020] = KEY_D;
	_glfw.keyCodes[0x012] = KEY_E;
	_glfw.keyCodes[0x021] = KEY_F;
	_glfw.keyCodes[0x022] = KEY_G;
	_glfw.keyCodes[0x023] = KEY_H;
	_glfw.keyCodes[0x017] = KEY_I;
	_glfw.keyCodes[0x024] = KEY_J;
	_glfw.keyCodes[0x025] = KEY_K;
	_glfw.keyCodes[0x026] = KEY_L;
	_glfw.keyCodes[0x032] = KEY_M;
	_glfw.keyCodes[0x031] = KEY_N;
	_glfw.keyCodes[0x018] = KEY_O;
	_glfw.keyCodes[0x019] = KEY_P;
	_glfw.keyCodes[0x010] = KEY_Q;
	_glfw.keyCodes[0x013] = KEY_R;
	_glfw.keyCodes[0x01F] = KEY_S;
	_glfw.keyCodes[0x014] = KEY_T;
	_glfw.keyCodes[0x016] = KEY_U;
	_glfw.keyCodes[0x02F] = KEY_V;
	_glfw.keyCodes[0x011] = KEY_W;
	_glfw.keyCodes[0x02D] = KEY_X;
	_glfw.keyCodes[0x015] = KEY_Y;
	_glfw.keyCodes[0x02C] = KEY_Z;

	_glfw.keyCodes[0x028] = KEY_APOSTROPHE;
	_glfw.keyCodes[0x02B] = KEY_BACKSLASH;
	_glfw.keyCodes[0x033] = KEY_COMMA;
	_glfw.keyCodes[0x00D] = KEY_EQUAL;
	_glfw.keyCodes[0x029] = KEY_GRAVE_ACCENT;
	_glfw.keyCodes[0x01A] = KEY_LEFT_BRACKET;
	_glfw.keyCodes[0x00C] = KEY_MINUS;
	_glfw.keyCodes[0x034] = KEY_PERIOD;
	_glfw.keyCodes[0x01B] = KEY_RIGHT_BRACKET;
	_glfw.keyCodes[0x027] = KEY_SEMICOLON;
	_glfw.keyCodes[0x035] = KEY_SLASH;
	_glfw.keyCodes[0x056] = KEY_WORLD_2;

	_glfw.keyCodes[0x00E] = KEY_BACKSPACE;
	_glfw.keyCodes[0x153] = KEY_DELETE;
	_glfw.keyCodes[0x14F] = KEY_END;
	_glfw.keyCodes[0x01C] = KEY_ENTER;
	_glfw.keyCodes[0x001] = KEY_ESCAPE;
	_glfw.keyCodes[0x147] = KEY_HOME;
	_glfw.keyCodes[0x152] = KEY_INSERT;
	_glfw.keyCodes[0x15D] = KEY_MENU;
	_glfw.keyCodes[0x151] = KEY_PAGE_DOWN;
	_glfw.keyCodes[0x149] = KEY_PAGE_UP;
	_glfw.keyCodes[0x045] = KEY_PAUSE;
	_glfw.keyCodes[0x039] = KEY_SPACE;
	_glfw.keyCodes[0x00F] = KEY_TAB;
	_glfw.keyCodes[0x03A] = KEY_CAPS_LOCK;
	_glfw.keyCodes[0x145] = KEY_NUM_LOCK;
	_glfw.keyCodes[0x046] = KEY_SCROLL_LOCK;
	_glfw.keyCodes[0x03B] = KEY_F1;
	_glfw.keyCodes[0x03C] = KEY_F2;
	_glfw.keyCodes[0x03D] = KEY_F3;
	_glfw.keyCodes[0x03E] = KEY_F4;
	_glfw.keyCodes[0x03F] = KEY_F5;
	_glfw.keyCodes[0x040] = KEY_F6;
	_glfw.keyCodes[0x041] = KEY_F7;
	_glfw.keyCodes[0x042] = KEY_F8;
	_glfw.keyCodes[0x043] = KEY_F9;
	_glfw.keyCodes[0x044] = KEY_F10;
	_glfw.keyCodes[0x057] = KEY_F11;
	_glfw.keyCodes[0x058] = KEY_F12;
	_glfw.keyCodes[0x064] = KEY_F13;
	_glfw.keyCodes[0x065] = KEY_F14;
	_glfw.keyCodes[0x066] = KEY_F15;
	_glfw.keyCodes[0x067] = KEY_F16;
	_glfw.keyCodes[0x068] = KEY_F17;
	_glfw.keyCodes[0x069] = KEY_F18;
	_glfw.keyCodes[0x06A] = KEY_F19;
	_glfw.keyCodes[0x06B] = KEY_F20;
	_glfw.keyCodes[0x06C] = KEY_F21;
	_glfw.keyCodes[0x06D] = KEY_F22;
	_glfw.keyCodes[0x06E] = KEY_F23;
	_glfw.keyCodes[0x076] = KEY_F24;
	_glfw.keyCodes[0x038] = KEY_LEFT_ALT;
	_glfw.keyCodes[0x01D] = KEY_LEFT_CONTROL;
	_glfw.keyCodes[0x02A] = KEY_LEFT_SHIFT;
	_glfw.keyCodes[0x15B] = KEY_LEFT_SUPER;
	_glfw.keyCodes[0x137] = KEY_PRINT_SCREEN;
	_glfw.keyCodes[0x138] = KEY_RIGHT_ALT;
	_glfw.keyCodes[0x11D] = KEY_RIGHT_CONTROL;
	_glfw.keyCodes[0x036] = KEY_RIGHT_SHIFT;
	_glfw.keyCodes[0x15C] = KEY_RIGHT_SUPER;
	_glfw.keyCodes[0x150] = KEY_DOWN;
	_glfw.keyCodes[0x14B] = KEY_LEFT;
	_glfw.keyCodes[0x14D] = KEY_RIGHT;
	_glfw.keyCodes[0x148] = KEY_UP;

	_glfw.keyCodes[0x052] = KEY_KP_0;
	_glfw.keyCodes[0x04F] = KEY_KP_1;
	_glfw.keyCodes[0x050] = KEY_KP_2;
	_glfw.keyCodes[0x051] = KEY_KP_3;
	_glfw.keyCodes[0x04B] = KEY_KP_4;
	_glfw.keyCodes[0x04C] = KEY_KP_5;
	_glfw.keyCodes[0x04D] = KEY_KP_6;
	_glfw.keyCodes[0x047] = KEY_KP_7;
	_glfw.keyCodes[0x048] = KEY_KP_8;
	_glfw.keyCodes[0x049] = KEY_KP_9;
	_glfw.keyCodes[0x04E] = KEY_KP_ADD;
	_glfw.keyCodes[0x053] = KEY_KP_DECIMAL;
	_glfw.keyCodes[0x135] = KEY_KP_DIVIDE;
	_glfw.keyCodes[0x11C] = KEY_KP_ENTER;
	_glfw.keyCodes[0x059] = KEY_KP_EQUAL;
	_glfw.keyCodes[0x037] = KEY_KP_MULTIPLY;
	_glfw.keyCodes[0x04A] = KEY_KP_SUBTRACT;
