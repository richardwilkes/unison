...
func (m *Monitor) gammaRamp() *GammaRamp { // formerly _plafGetGammaRamp
...
func (m *Monitor) setGammaRamp(ramp *GammaRamp) { // formerly _plafSetGammaRamp
...
func pollMonitors() { // formerly _plafPollMonitors
	// TODO: Implement
}
