...
var DefaultFieldTheme = FieldTheme{
	...
	EditableInk:      PrimaryTheme.Surface.DeriveLightness(0.05, -0.1),
	OnEditableInk:    PrimaryTheme.Surface.DeriveLightness(0.05, -0.1).DeriveOn(),
	SelectionInk:     &PrimaryTheme.Primary,
	OnSelectionInk:   PrimaryTheme.Primary.DeriveOn(),
	ErrorInk:         &PrimaryTheme.Error,
	OnErrorInk:       PrimaryTheme.Error.DeriveOn(),
